              ...
              <section>
                ...
                {savings > 0 && (
                  <div style={{ marginTop: 16, textAlign: 'center' }}>
                    <a
                      href={`https://wa.me/?text=${encodeURIComponent(`I'm saving ₹${savings} on my medicine cart using MedCompare 💊 Compare prices & find the cheapest option: https://medcompare.app`)}`}
                      target="_blank" rel="noopener noreferrer"
                      style={{ display: 'inline-flex', alignItems: 'center', gap: 7, background: '#25D366', color: 'white', borderRadius: 14, padding: '10px 18px', fontSize: 13, fontWeight: 600, textDecoration: 'none' }}
                    >
