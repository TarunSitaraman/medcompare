            ...
            <div style={{ marginTop: 8 }}>
              {monthSavings > 0 && (
                <div style={{
                  ...
                  <a
                    href={`https://wa.me/?text=${encodeURIComponent(`I saved ₹${monthSavings} this month on medicines using MedCompare 💊 Compare prices & find generics: https://medcompare.app`)}`}
